...
const like_controller_1 = __importDefault(require("../controllers/like_controller"));
 ...
 */
router.post("/createLike", auth_controller_1.authMiddleware, like_controller_1.default.createLike);
/**
 * @swagger
 * /api/like/getLikes:
 *   get:
 ...
 *         description: Internal server error
 */
router.get("/getLikes", auth_controller_1.authMiddleware, like_controller_1.default.getLikes);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get("/getLikesByPostId/:postId", auth_controller_1.authMiddleware, like_controller_1.default.getLikesByPostId);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.delete("/deleteLike/:likeId", auth_controller_1.authMiddleware, like_controller_1.default.deleteLike);
