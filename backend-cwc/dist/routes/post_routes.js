 ...
 */
router.post("/createPost", auth_controller_1.authMiddleware, post_controller_1.default.createPost);
/**
 * @swagger
 * /api/post/getPosts:
 *   get:
 ...
 *         description: Internal server error
 */
router.get("/getPosts", post_controller_1.default.getPosts);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get("/getPostById/:postId", post_controller_1.default.getPostById);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get("/getPostByUserId/:userId", auth_controller_1.authMiddleware, post_controller_1.default.getPostByUserId);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.put("/updatePostById/:postId", auth_controller_1.authMiddleware, post_controller_1.default.updatePostById);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.delete("/deletePostById/:postId", auth_controller_1.authMiddleware, post_controller_1.default.deletePostById);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post("/likePost/:postId", auth_controller_1.authMiddleware, post_controller_1.default.updateLikeToPost);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.delete("/removeLike/:postId", auth_controller_1.authMiddleware, post_controller_1.default.removeLikeToPost);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post("/commentPost/:postId", auth_controller_1.authMiddleware, post_controller_1.default.updateCommentToPost);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.delete("/removeComment/:postId", auth_controller_1.authMiddleware, post_controller_1.default.removeCommentToPost);
