 ...
 *         description: Internal server error
 */
router.get("/me", auth_controller_1.default.getUser);
/**
 * @swagger
 * /api/auth/logout:
 *   post:
...
router.post("/generateContent", auth_controller_1.default.chatController);
router.get("/getUserNameById/:id", auth_controller_1.default.getNameByid);
router.post("/google", auth_controller_1.default.googleLogin);
router.post("/refresh", auth_controller_1.default.refresh);
router.post("/generateTokens", auth_controller_1.default.handleGenerateTokens);
router.post("/verifyRefreshToken", auth_controller_1.default.handleVerifyRefreshToken);
